...
The optimizer tries multiple random starting points (10 by default) and returns the lowest energy conformer, helping find better local minima and satisfy dihedral constraints more reliably.
